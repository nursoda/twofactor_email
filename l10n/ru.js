OC.L10N.register(
	...
	"Enable Two-Factor Email" : "Включить двухфакторную аутентификацию по электронной почте",
	...
	"Two-Factor Email is enabled. Codes are sent to {emailAddress}." : "Двухфакторная аутентификация по электроннаой почте включена. Коды подтверждения будут отправлены на {emailAddress}.",
