...
If you want to enhance this app, please contact me, and put your efforts in the version 3 ("v3") of this app, which requires Nextcloud 32. It now lives in my company's repository [datenschutz-individuell/twofactor_email](https://github.com/datenschutz-individuell/twofactor_email). There now is a beta version in the App store (see above) which you may want to test.
